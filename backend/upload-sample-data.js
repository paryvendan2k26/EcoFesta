...
async function uploadSampleData() {
  try {
    ...
    const usersData = JSON.parse(fs.readFileSync(path.join(__dirname, '../sample-data/sample-users.json'), 'utf8'));
    const productsData = JSON.parse(fs.readFileSync(path.join(__dirname, '../sample-data/sample-products.json'), 'utf8'));
    const donationsData = JSON.parse(fs.readFileSync(path.join(__dirname, '../sample-data/sample-donations.json'), 'utf8'));
